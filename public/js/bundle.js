...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmQyMDAyIiwiYSI6ImNsa2M4NGcycDAwazIzZHBkNWRpOHlveTIifQ.8f_FI9isxuu5s0mcsUoweA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/fd2002/clkcaz63u000n01pocmhh4ewu',
    scrollZoom: false
    //   zoom: 10,
    //   interactive: false,
  });
...
function initStripe() {
  loadStripeJs(function () {
    stripe = Stripe('pk_test_51NmAO0HDYTo3YXlYClQTeaLKfayjCFpHbowVNl31reO36slAzSDGHTTTum50LTObOCMpVqT83BX0WtVJWEsigEF900WbsNmtOr');
  });
}
